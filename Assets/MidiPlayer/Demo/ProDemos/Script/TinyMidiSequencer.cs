...
namespace DemoMPTK
{
    public class TinyMidiSequencer : MonoBehaviour
    {
        ...
        /// </summary>
        MidiFileWriter2 midiFileWriter;
        ...
        private void PatchChange(int patch)
        {
            ...
            midiFileWriter.MPTK_AddChangePresetMilli(1, CurrentTimeMs, 1, patch);
        }
        ...
        private void NewNote(KeyboardState ks)
        {
            ...
            midiFileWriter.MPTK_AddNoteMilli(1, CurrentTimeMs, 1, ks.Key, 100, -1);
        }
        ...
        private void StopNote(KeyboardState ks)
        {
            if (ks.Note != null)
            {
                ...
                midiFileWriter.MPTK_AddOffMilli(1, CurrentTimeMs, 1, ks.Key);
        ...
        private static void PlayDirectlyMidiSequence(string name, MidiFileWriter2 mfw)
        {
        ...
        private static void WriteMidiSequenceToFileAndPlay(string name, MidiFileWriter2 mfw)
        {
