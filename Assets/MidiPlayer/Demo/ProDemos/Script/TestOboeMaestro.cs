...
namespace MPTKDemoEuclidean
{
    public class TestOboeMaestro : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            TogApplyFilter.onValueChanged.AddListener((bool apply) => { midiFilePlayer.MPTK_ApplySFFilter = apply; });
            TogApplyReverb.onValueChanged.AddListener((bool apply) => { midiFilePlayer.MPTK_ApplySFReverb = apply; });
        ...
        private void Update()
        {
            ...
            else
            {
                ...
                if (midiFilePlayer.MPTK_IsPlaying)
                {
                    ...
                    TogApplyFilter.SetIsOnWithoutNotify(midiFilePlayer.MPTK_ApplySFFilter);
                    TogApplyReverb.SetIsOnWithoutNotify(midiFilePlayer.MPTK_ApplySFReverb);
                }
