...
namespace MidiPlayerTK
{
    public class MPTKGui
    {
        ...
        static private Texture iconPlay; static public Texture IconPlay { get { if (iconPlay == null) iconPlay = Resources.Load<Texture2D>("Textures/icons8-play-50"); return iconPlay; } }
        static private Texture iconPlaying; static public Texture IconPlaying { get { if (iconPlaying == null) iconPlaying = Resources.Load<Texture2D>("Textures/icons8-playing"); return iconPlaying; } }
        static private Texture iconLoop; static public Texture IconLoop { get { if (iconLoop == null) iconLoop = Resources.Load<Texture2D>("Textures/icons8-repeat-50"); return iconLoop; } }
        static private Texture iconLooping; static public Texture IconLooping { get { if (iconLooping == null) iconLooping = Resources.Load<Texture2D>("Textures/icons8-repeating"); return iconLooping; } }
        static private Texture iconLoopStart; static public Texture IconLoopStart { get { if (iconLoopStart == null) iconLoopStart = Resources.Load<Texture2D>("Textures/icons8-loop-start"); return iconLoopStart; } }
        static private Texture iconLoopStartSet; static public Texture IconLoopStartSet { get { if (iconLoopStartSet == null) iconLoopStartSet = Resources.Load<Texture2D>("Textures/icons8-loop-start-set"); return iconLoopStartSet; } }
        static private Texture iconLoopStop; static public Texture IconLoopStop { get { if (iconLoopStop == null) iconLoopStop = Resources.Load<Texture2D>("Textures/icons8-loop-stop"); return iconLoopStop; } }
        static private Texture iconLoopStopSet; static public Texture IconLoopStopSet { get { if (iconLoopStopSet == null) iconLoopStopSet = Resources.Load<Texture2D>("Textures/icons8-loop-stop-set"); return iconLoopStopSet; } }
        static private Texture iconLoopReset; static public Texture IconLoopReset { get { if (iconLoopReset == null) iconLoopReset = Resources.Load<Texture2D>("Textures/icons8-loop-reset"); return iconLoopReset; } }
        static private Texture iconModeLoop; static public Texture IconModeLoop { get { if (iconModeLoop == null) iconModeLoop = Resources.Load<Texture2D>("Textures/icons8-mode-loop"); return iconModeLoop; } }
        static private Texture iconPause; static public Texture IconPause { get { if (iconPause == null) iconPause = Resources.Load<Texture2D>("Textures/icons8-pause-50"); return iconPause; } }
        static private Texture iconPauseActivated; static public Texture IconPauseActivated { get { if (iconPauseActivated == null) iconPauseActivated = Resources.Load<Texture2D>("Textures/icons8-pause-activated"); return iconPauseActivated; } }
        static private Texture iconStop; static public Texture IconStop { get { if (iconStop == null) iconStop = Resources.Load<Texture2D>("Textures/icons8-stop-50"); return iconStop; } }
