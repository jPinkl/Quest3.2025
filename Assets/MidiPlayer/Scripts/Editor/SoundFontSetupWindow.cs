            ...
            try
            {
                ...
                if (MidiPlayerGlobal.ImSFCurrent != null)
                {
                    ...
                    RemoveUnusedWaves = GUILayout.Toggle(RemoveUnusedWaves,
                        new GUIContent("Remove unused samples   ", "If check, keep only samples used by your midi files and/or in the selected banks"), MPTKGui.styleToggle);
                    LogDetailSoundFont = GUILayout.Toggle(LogDetailSoundFont,
                        new GUIContent("Log SoundFont Detail", "If check, keep only samples used by your midi files"), MPTKGui.styleToggle);
