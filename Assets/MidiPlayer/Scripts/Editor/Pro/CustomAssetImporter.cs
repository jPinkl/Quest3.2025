...
namespace MidiPlayerTK
{
    internal sealed class CustomAssetImporter : AssetPostprocessor
    {
        ...
        private void OnPreprocessAudio()
        {
            ...
            {
                Debug.Log($"SoundFontName:{MidiPlayerGlobal.ImSFCurrent.SoundFontName} CompressionFormat:{MidiPlayerGlobal.ImSFCurrent.CompressionFormat} LoadType:{MidiPlayerGlobal.ImSFCurrent.LoadType}");
